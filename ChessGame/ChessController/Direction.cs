...
{
    //used to represent movement directions for pieces
    //set methods for change in row and column from a given position
    ...
    {
        return new Direction(scalar * dir.RowDelta, 
                    scalar * dir.ColumnDelta);
    }
}